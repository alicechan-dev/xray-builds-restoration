// CUIMapBackground.cpp:перемещаема€ картинка (сам ландшафт)
//						интреактивной карты
//////////////////////////////////////////////////////////////////////
...
//-----------------------------------------------------------------------------/
//	¬ызываетс€ каждый раз перед вызовом карты
//-----------------------------------------------------------------------------/
...
//-----------------------------------------------------------------------------/
//	ѕеревод из мировой системы координат в координаты карты на экране
...
//-----------------------------------------------------------------------------/
//	ѕеревод из мировой системы координат в 
...
//-----------------------------------------------------------------------------/
//	”становить положение карты, так чтобы актер 
//	был по центру
//-----------------------------------------------------------------------------/
...
//-----------------------------------------------------------------------------/
//	÷ентрируем карту по заданной активной точке
//-----------------------------------------------------------------------------/

void CUIMapBackground::UpdateActivePos()
{
	//установить положение карты, так чтобы задана€ точка 
	//была по центру
