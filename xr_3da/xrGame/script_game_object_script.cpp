...
void CScriptGameObject::script_register(lua_State *L)
{
	...
	[
		class_<CScriptGameObject>("game_object")
			...
			.def("set_callback",				(void (CScriptGameObject::*)(const luabind::object &, bool))(&CScriptGameObject::SetCallback))
			...
			.def("set_callback",				(void (CScriptGameObject::*)(const luabind::object &, const ScriptMonster::EActionType))(&CScriptGameObject::SetCallback))
			...
			.def("set_hit_callback",			(void (CScriptGameObject::*)(const luabind::object &))(&CScriptGameObject::SetHitCallback))
			...
			.def("set_hear_callback",			(void (CScriptGameObject::*)(const luabind::object &))(&CScriptGameObject::SetSoundCallback))
			...
			.def("set_pda_callback",			(void (CScriptGameObject::*)(const luabind::object&))(&CScriptGameObject::SetPdaCallback))
			...
			.def("set_info_callback",			(void (CScriptGameObject::*)(const luabind::object&))(&CScriptGameObject::SetInfoCallback))
			...
			.def("set_trade_callback",			(void (CScriptGameObject::*)(const luabind::object &))(&CScriptGameObject::SetTradeCallback))
			...
			.def("set_use_callback",			(void (CScriptGameObject::*)(const luabind::object &))(&CScriptGameObject::SetUseCallback))
