...
| `Gauss` | `BUILD_XR_GAUSS` | Release builds as a verified x86 image-filter DLL with three expected exports. | Functional image-kernel tests remain future work. |
