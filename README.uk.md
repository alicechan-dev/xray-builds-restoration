...
Оригінальні runtime assets не надаються цим репозиторієм. Runtime data мають походити з вашої власної законної копії, архіву або дослідницьких матеріалів.
...
* `-freecursor` робить non-exclusive лише DirectInput mouse device.
* `-freeinput` робить mouse і keyboard DirectInput devices non-exclusive для windowed debugging.
...
Використовуйте це лише з legally obtained compatible runtime data package з вашої власної законної копії, архіву або дослідницьких матеріалів.
